...
namespace Slang
{
    ...
    private:
        ...
        tint_FreeBufferFunc m_freeBuffer;
    };
    ...
    SlangResult TintDownstreamCompiler::init(ISlangSharedLibrary* library)
    {
        ...
        tint_FreeBufferFunc freeBuffer =
            (tint_FreeBufferFunc)library->findFuncByName("tint_free_buffer");
        ...
        DownstreamCompilerSet* set)
    {
        ...
        SLANG_RETURN_ON_FAIL(
            static_cast<TintDownstreamCompiler*>(compiler.get())->init(library));
        ...
        IArtifact *const sourceArtifact, IArtifact** outArtifact)
    {
        ...
        SLANG_DEFER(m_freeBuffer((void*)result.buffer));
        SLANG_DEFER(m_freeBuffer((void*)result.error));
